...
enum {
	B_PARTITION_CHANGED_OFFSET				= 0x0001,
	B_PARTITION_CHANGED_SIZE				= 0x0002,
	B_PARTITION_CHANGED_BLOCK_SIZE			= 0x0004,
	B_PARTITION_CHANGED_STATUS				= 0x0008,
	B_PARTITION_CHANGED_FLAGS				= 0x0010,
	B_PARTITION_CHANGED_VOLUME				= 0x0020,
	B_PARTITION_CHANGED_NAME				= 0x0040,
	B_PARTITION_CHANGED_CONTENT_NAME		= 0x0080,
	B_PARTITION_CHANGED_TYPE				= 0x0100,
	B_PARTITION_CHANGED_CONTENT_TYPE		= 0x0200,
	B_PARTITION_CHANGED_PARAMETERS			= 0x0400,
	B_PARTITION_CHANGED_CONTENT_PARAMETERS	= 0x0800,
	B_PARTITION_CHANGED_CHILDREN			= 0x1000,
};
