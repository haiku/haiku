...
enum {
	...
	B_PARTITION_CHANGED_BLOCK_SIZE			= 0x000004,
	B_PARTITION_CHANGED_STATUS				= 0x000008,
	B_PARTITION_CHANGED_FLAGS				= 0x000010,
	B_PARTITION_CHANGED_VOLUME				= 0x000020,
	B_PARTITION_CHANGED_NAME				= 0x000040,
	B_PARTITION_CHANGED_CONTENT_NAME		= 0x000080,
	B_PARTITION_CHANGED_TYPE				= 0x000100,
	B_PARTITION_CHANGED_CONTENT_TYPE		= 0x000200,
	B_PARTITION_CHANGED_PARAMETERS			= 0x000400,
	B_PARTITION_CHANGED_CONTENT_PARAMETERS	= 0x000800,
	B_PARTITION_CHANGED_CHILDREN			= 0x001000,
	B_PARTITION_CHANGED_DESCENDANTS			= 0x002000,
	B_PARTITION_CHANGED_DEFRAGMENTATION		= 0x004000,
	B_PARTITION_CHANGED_CHECK				= 0x008000,
	B_PARTITION_CHANGED_REPAIR				= 0x010000,
	B_PARTITION_CHANGED_INITIALIZATION		= 0x020000,
};
