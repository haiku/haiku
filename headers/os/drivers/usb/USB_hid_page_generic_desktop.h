...
enum {
	...
	// HID Usage Tables Ver. 1.5, section 4.10 "Wireless Radio Controls" (HUTRR40)
	B_HID_UID_GD_WIRELESS_RADIO_CONTROLS = 0x0c,
	...
	// HID Usage Tables Ver. 1.5, section 4.10 "Wireless Radio Controls" (HUTRR40)
	B_HID_UID_GD_WIRELESS_RADIO_BUTTON = 0xc6,
	B_HID_UID_GD_WIRELESS_RADIO_LED,
	B_HID_UID_GD_WIRELESS_RADIO_SLIDER_SWITCH
};
