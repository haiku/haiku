...
enum {
	...
	// HID Usage Tables Ver. 1.5, section 15 "Consumer Page" (HUTRR77)
	B_HID_UID_CON_AC_SOFT_KEY_LEFT = 0x2a0,
	B_HID_UID_CON_AC_SOFT_KEY_RIGHT,
	B_HID_UID_CON_AC_DESKTOP_SHOW_ALL_APPLICATIONS
};
