...
enum { // Communication Interface Subclasses
	...
	USB_CDC_COMMUNICATION_INTERFACE_WHCM_SUBCLASS,			// Wireless Handset Control Model
	USB_CDC_COMMUNICATION_INTERFACE_DM_SUBCLASS,			// Device Management
	USB_CDC_COMMUNICATION_INTERFACE_MDLM_SUBCLASS,			// Mobile Direct Line Model
	USB_CDC_COMMUNICATION_INTERFACE_OBEX_SUBCLASS,			// OBject EXchange
	USB_CDC_COMMUNICATION_INTERFACE_EEM_SUBCLASS,			// Ethernet Emulation Model
	USB_CDC_COMMUNICATION_INTERFACE_NCM_SUBCLASS,			// Network Control Model
	USB_CDC_COMMUNICATION_INTERFACE_MBM_SUBCLASS			// Mobile Broadband Model
};
...
enum { // Management Element Requests (p62)
	...
	// 0x80 -> 0x8A: NCM configuration requests (USB-NCM 1.1 page 48)
	...
	USB_CDC_GET_MAX_DGRAM_SIZE,
	USB_CDC_SET_MAX_DGRAM_SIZE,
	USB_CDC_GET_CRC_MODE,
	USB_CDC_SET_CRC_MODE,
	// 0x8B -> 0xFF: reserved for future use
};
