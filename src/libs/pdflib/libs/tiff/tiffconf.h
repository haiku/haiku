/* PDFlib GmbH cvsid: $Id: tiffconf.h,v 1.1 2004/10/06 17:46:51 laplace Exp $ */
/*
...
#define	LZW_SUPPORT		/* PDFlib GmbH, required for predictor tag */
#undef	THUNDER_SUPPORT		/* PDFlib GmbH */
#undef OJPEG_SUPPORT		/* PDFlib GmbH */
#undef JPEG_SUPPORT		/* PDFlib GmbH */
