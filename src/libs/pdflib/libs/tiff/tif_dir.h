/* PDFlib GmbH cvsid: $Id: tif_dir.h,v 1.1 2004/10/06 17:46:51 laplace Exp $ */
...
typedef	struct {
	...
	tif_short field_bit;		/* bit in fieldsset bit vector */
	tif_char field_oktochange;	/* if true, can change while writing */
	tif_char field_passcount;	/* if true, pass dir count on set */
