/* PDFlib GmbH cvsid: $Id: pngset.c,v 1.1 2004/10/06 17:46:50 laplace Exp $ */
...
png_set_gAMA(png_structp png_ptr, png_infop info_ptr, double file_gamma)
{
   ...
   if (file_gamma > 21474.83)
   {
      ...
      tgamma=file_gamma;
   info_ptr->gamma = (float)tgamma;
#ifdef PNG_FIXED_POINT_SUPPORTED
   info_ptr->int_gamma = (int)(tgamma*100000.+.5);
#endif
...
#ifdef PNG_FLOATING_POINT_SUPPORTED
   info_ptr->gamma = (float)(tgamma/100000.);
#endif
#ifdef PNG_FIXED_POINT_SUPPORTED
   info_ptr->int_gamma = tgamma;
#endif
   info_ptr->valid |= PNG_INFO_gAMA;
   if(tgamma == 0)
      png_warning(png_ptr, "Setting gamma=0");
