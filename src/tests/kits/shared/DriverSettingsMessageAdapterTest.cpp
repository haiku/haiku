...
class DriverSettingsMessageAdapterTest : public CppUnit::TestFixture {
	CPPUNIT_TEST_SUITE(DriverSettingsMessageAdapterTest);
...
public:
	void TestWildcard()
	{
		...
		CPPUNIT_ASSERT_EQUAL(42, (int)message.GetInt32("test", 0, 0));
		CPPUNIT_ASSERT_EQUAL(43, (int)message.GetInt32("test", 1, 0));
	...
	void TestPrimitivesToMessage()
	{
		...
		BMessage message;
		CPPUNIT_ASSERT_EQUAL(B_OK, settings.ToMessage(kTemplate, message));
		CPPUNIT_ASSERT_EQUAL(10, (int)message.CountNames(B_BOOL_TYPE));
		CPPUNIT_ASSERT_EQUAL(2, (int)message.CountNames(B_INT32_TYPE));
		CPPUNIT_ASSERT_EQUAL(2, (int)message.CountNames(B_STRING_TYPE));
		CPPUNIT_ASSERT_EQUAL(14, (int)message.CountNames(B_ANY_TYPE));
		...
		// int32 values
		CPPUNIT_ASSERT_EQUAL(42, (int)message.GetInt32("int32", 0));
		CPPUNIT_ASSERT_EQUAL(-42, (int)message.GetInt32("negative_int32", 0));
...
CPPUNIT_TEST_SUITE_NAMED_REGISTRATION(DriverSettingsMessageAdapterTest,
	getTestSuiteName());
