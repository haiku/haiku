...
// NodeHandle
class NodeHandle : public Referencable, public Lockable {
public:
								NodeHandle();
	virtual						~NodeHandle();
...
// DirIterator
class DirIterator : public NodeHandle, public DLListLinkImpl<DirIterator> {
public:
								DirIterator();
	virtual						~DirIterator();
...
// Query
class Query : public BQuery, public DLListLinkImpl<Query> {
public:
};
