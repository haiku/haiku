...
typedef struct tagdevice_infoblock {
	...
	uint16 dummy5[2];			// 5e
	B_LBITFIELD16_5 (			// 62 (49) capabilities
		_49_ret1			: 8,
		DMA_supported		: 1,
		LBA_supported		: 1,
		IORDY_can_disable	: 1,
	...
	uint16 dummy6[1];			// 64
	B_LBITFIELD16_2 (			// 66 (51) obsolete: PIO modes?
		_51_obs1			: 8,
		PIO_mode			: 8
	);
	uint16 dummy7[1];			// 68

	B_LBITFIELD16_3 (			// 6a (53) validity
		_54_58_valid		: 1,
		_64_70_valid		: 1,
		_88_valid			: 1
	);
	...
	B_LBITFIELD16_7 ( 			// 7e (63) MDMA modes
		MDMA0_supported		: 1,
		MDMA1_supported		: 1,
		MDMA2_supported		: 1,
		_63_res1			: 5,
	...
	B_LBITFIELD16_2 (			// 96 (75)
		queue_depth			: 5,
		_75_res1			: 9
	);
	uint16 dummy11[6];			// 98

	B_LBITFIELD16_16 (			// a4 (82) supported_command_set
		SMART_supported				: 1,
	...
	B_LBITFIELD16_15 (			// a6 (83) supported_command_sets
	...
	B_LBITFIELD16_15 (			// b0 (88) UDMA modes
		UDMA0_supported		: 1,
		UDMA1_supported		: 1,
		UDMA2_supported		: 1,
		UDMA3_supported		: 1,
	...
	B_LBITFIELD16_2 (			// fc (126)
		last_lun			: 2,
		_126_res2			: 14
	);
	B_LBITFIELD16_4 (			// fe (127) RMSN support
