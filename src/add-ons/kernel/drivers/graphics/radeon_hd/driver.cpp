...
const struct supported_device {
	...
	//  Kabini DCE 8.3
	{0x9830, 8, 3, RADEON_KABINI, CHIP_STD, "Radeon HD Kabini"},
	{0x9831, 8, 3, RADEON_KABINI, CHIP_STD, "Radeon HD Kabini"},
	{0x9832, 8, 3, RADEON_KABINI, CHIP_STD, "Radeon HD Kabini"},
	{0x9833, 8, 3, RADEON_KABINI, CHIP_STD, "Radeon HD Kabini"},
	{0x9834, 8, 3, RADEON_KABINI, CHIP_STD, "Radeon HD Kabini"},
	{0x9835, 8, 3, RADEON_KABINI, CHIP_STD, "Radeon HD Kabini"},
	{0x9836, 8, 3, RADEON_KABINI, CHIP_STD, "Radeon HD Kabini"},
	{0x9837, 8, 3, RADEON_KABINI, CHIP_STD, "Radeon HD Kabini"},
	{0x9838, 8, 3, RADEON_KABINI, CHIP_STD, "Radeon HD Kabini"},
	{0x9839, 8, 3, RADEON_KABINI, CHIP_STD, "Radeon HD Kabini"},
	...
	{0x983d, 8, 3, RADEON_KABINI, CHIP_STD, "Radeon HD Kabini"},
	{0x983e, 8, 3, RADEON_KABINI, CHIP_STD, "Radeon HD Kabini"},
	{0x983f, 8, 3, RADEON_KABINI, CHIP_STD, "Radeon HD Kabini"},
	//  Mullins DCE 8.3
	{0x9850, 8, 3, RADEON_MULLINS, CHIP_STD, "Radeon HD Mullins"},
