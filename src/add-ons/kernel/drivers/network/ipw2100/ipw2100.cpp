...
IPW2100::LoadMicrocodeAndFirmware()
{
	const char *firmware;
	switch (fMode) {
		case IPW_MODE_BSS:	firmware = "/etc/firmware/ipw2100/ipw2100-1.3.fw"; break;
		case IPW_MODE_IBSS:	firmware = "/etc/firmware/ipw2100/ipw2100-1.3-i.fw"; break;
		case IPW_MODE_MONITOR: firmware = "/etc/firmware/ipw2100/ipw2100-1.3-p.fw"; break;
